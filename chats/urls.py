...
from chats.views import (
    ...
    ChatMessagesAPIView,
    ZhatsDestroyAPIView,
    ZhatsBlockingCreateAPIView, ZhatRemoveBlocking, MessageCreateAPIView,
    # RealtyMessagesAPIView,
)
...
urlpatterns = [
    ...
    path('show-chat/', ChatMessagesAPIView.as_view(), name='chat-messages'), # New combined endpoint!
    ...
    path('delete-chats/', ZhatsDestroyAPIView.as_view(), name='destroy'),  # ex-multiple-del
