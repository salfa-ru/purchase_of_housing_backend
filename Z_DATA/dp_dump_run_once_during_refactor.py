...
exclude_apps = [
    "admin", "authtoken", "chats", "complaints", "contenttypes",
    "corsheaders", "django_q", "django_filters", "drf_spectacular",
    "messages", "realty_photos", "rest_framework", "staticfiles", "sessions",
...
exclude_models = {
    ...
    "realty_specificities": ["aboutapartment",
                             "aboutbuilding",
...
for app_config in django_apps.get_app_configs():
    ...
    for model in app_config.get_models():
        ...
        output_file = f"Z_DATA/db_dump_before_deply_refactor/{app_label}.{model_name}.json"
