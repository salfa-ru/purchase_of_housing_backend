...
Прим.: среди данных созданы 2 пользователя Иван и Петр, пароль 123. 
Пользователи под id 2 b 3, т.е. чтобы загрузка данных прошла успешно, в БД не должно быть пользователей с таким id.
